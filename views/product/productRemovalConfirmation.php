...
if (isset($params)) {
    ...
    <form class="row" action="index.php" method="post">
        <div class="row mt-5 d-flex justify-content-center">
            <p class="h4 text-center">Are you sure you want to delete product {$params["product"]->getCode()}?</p>
        </div>
        <br>
        <br>
        <div class="row d-flex justify-content-center">
                ...
                <div class="col-auto">
                    <button class="btn btn-danger" name="action" value="product/remove" type="submit" >Confirm</button>
                </div>
                <div class="col-auto">
