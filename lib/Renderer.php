...
class Renderer {
    ...
    public static function renderProductFields(Product $product): string {
        ...
        $result .= self::renderLabelInput("Category Id: ", "categoryId", $product->getCategoryId(), "placeholder='categoryId'");
        $result .= "</fieldset>";
        return $result;
    }
    ...
    public static function renderWarehouseFields(Warehouse $warehouse): string {
        ...
        $result .= self::renderLabelInput("Adress: ", "adress", $warehouse->getAddress(), "placeholder='adress'");
        $result .= "</fieldset>";
        return $result;
    }
